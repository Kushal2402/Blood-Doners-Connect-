...
{
  $sql="SELECT * FROM admin WHERE username='$uname' and password='$pssword'";
  $result=mysqli_query($con,$sql);
  $row=mysqli_fetch_array($result);
  if($row['username']== $uname && $row['password']== $pssword){
...
<body>
    <header>
        ...
        <div id="admin">
            ...
            <a href="#" onclick="alert('This is the admin login page!')">Admin</a>
        </div>
    </header>
            ...
            <div class="row">
                ...
                <div id="signup" class="col-lg-6 col-md-8 align-self-center">
                    <div id="formcontent">
                        ...
                        <input type="text" name="username" id="username" placeholder="Enter Admin Username" class="form-control">
                        <br>
                        ...
                        <button class="btn btn-danger btn-block" type="submit" id="login" name="login">Login</button>
                        <br>
                    </div>
                </div>
